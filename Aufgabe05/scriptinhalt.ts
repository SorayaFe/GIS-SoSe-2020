namespace Aufgabe05 {
    ...
    const weissbier: Artikel = {_name: "Weißbier", _beschreibung: "Der absolute Favorit der Deutschen als Schokolade!", _preis: "1,49€  ", _bild: "weißbier-rs.png", _bildAlt: "Weißbier", _verfuegbar: true};
    const leberkaese: Artikel = {_name: "Leberkäse", _beschreibung: "Statt im Wecken jetzt in der Schokolade!", _preis: "1,49€  ", _bild: "leberkäse-rs.png", _bildAlt: "Leberkäse", _verfuegbar: true};
